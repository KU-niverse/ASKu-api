...
export const newActionRecord = async (req: Request, res: Response, next: NextFunction) => {  
  try {
...
export const newActionRevise = async (req: Request, res: Response, next: NextFunction) => {  
  try {
...
export const newActionReport = async (req: Request, res: Response) => {  
  try {
...
export const newActionDebate = async (req: Request, res: Response) => {  
  try {
...
export const newActionQuestion = async (req: Request, res: Response, next: NextFunction) => {  
  try {
...
export const newActionLike = async (req: Request, res: Response) => {  
  try {
...
export const newActionAnswer = async (req: Request, res: Response, next: NextFunction) => {  
  try {
...
export const cancelActionQuestion = async (req: Request, res: Response) => {  
  try {
...
// export const newActionDefault = async (req: Request, res: Response, next: NextFunction) => {
//   try {
//     next();
//   } catch (err) {
//     console.error(err);
